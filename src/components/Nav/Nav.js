...
//    console.log(navPages)
    ...
    return ( 
        ...
        <div className="col-span-1 h-screen bg-[#231b2e] relative ">
            <div className="  w-full h-16 bg-[#000000] absolute bottom-20 flex flex-row justify-between items-center px-5 text-white">
