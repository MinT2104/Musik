...
// })
    return ( 
    <>
        <h1 className='font-bold text-xl text-white uppercase ml-12 mt-5 text-center'>All Songs</h1>
        <div className="w-4/5 h-fit mx-auto mt-10">
            ...
            {dataSongs[0].map((items ,index)=>(
                ...
                key={index} 
                className="break-words flex flex-col w-52 gap-2  hover:translate-y-3 duration-300 mb-10">
                    <div className="cursor-pointer truncate w-52 h-52 bg-gray-200 rounded-3xl flex items-center justify-center cursor-pointer">
                      <img 
