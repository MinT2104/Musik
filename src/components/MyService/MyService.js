const MyService = () => {
    const btn = ' mx-auto text-[#FA2FB5] p-2 w-3/5 text-lg bg-none border-[1px] border-[#FA2FB5] rounded-full px-5 hover:text-[#FFC23C] hover:border-[#FFC23C] duration-300'
    return ( 
        <footer className="w-full h-fit bg-black grid grid-cols-5 text-white pb-40">
            <div className="col-span-2 flex items-center justify-top flex-col">
                ...
                <ul className="flex flex-row gap-5  items-center justify-center h-2/5">
                    <li className="hover:scale-110 duration-300">
                        <a className="cursor-pointer" href="https://www.facebook.com/pkkute.account.pass">
                            <span className="iconify text-[50px]" data-icon="logos:facebook" ></span>
                        </a>
                    </li>
                    <li className="w-fit hover:scale-110 duration-300">
                        <a className="cursor-pointer" href="https://www.facebook.com/pkkute.account.pass">
                    <span className="iconify text-[60px] text-red-700" data-icon="ant-design:instagram-filled" ></span>
                        </a>
                    </li>
                    <li className="hover:scale-110 duration-300">
                        <a className="cursor-pointer" href="https://www.facebook.com/pkkute.account.pass">
                    <span className="iconify text-[40px]" data-icon="logos:youtube-icon"></span>
                        </a>
                    </li>
                </ul>
            </div>
            ...
            <div className="col-span-2 flex flex-col items-center gap-5">
                ...
                <input className="w-3/5 h-10 rounded-sm p-2 pl-5 text-black font-semibold outline-none" placeholder="Write your Email..."/>
