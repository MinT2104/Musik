const HotPlaylist = () => {
    return ( 
        ...
        <h1 className='font-bold text-xl text-white uppercase ml-12 mt-5'>Popular Playlist</h1>
            <div className="w-4/5 mx-auto mt-5 md:p-4 rounded-3xl flex flex-row flex-wrap justify-between mb-20 gap-5">
                <div className=" flex flex-col w-fit gap-2 hover:translate-y-1.5 duration-300 items-center">
                    <div className="cursor-pointer truncate h-32 w-32 md:w-36 md:h-36 bg-gray-200 rounded-3xl flex items-center justify-center cursor-pointer">
