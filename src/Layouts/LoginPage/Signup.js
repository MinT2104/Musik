    ...
    return ( 
        <section className="text-white h-screen bg-[#170f23] z-20 absolute w-full top-0 left-0">
            <div className="relative w-full h-screen flex flex-row items-center justify-center">
                <div className="py-3 w-96 h-fit bg-[#231b2e] rounded-xl flex flex-col items-center">
                    <h1 className="text-xl font-bold uppercase text-center p-2">LogIn</h1>
                    ...
                    <div>Have an account? &nbsp;
                        <Link to="/login" className="font-medium text-blue-500 cursor-pointer">
                            Sign in
                        </Link>
                    </div>
                </div>
